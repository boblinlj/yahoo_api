...
class YahooAPI_to_JSON_file(ABC):
    ...
    def load_to_staging(self) -> None:
        ...
        self.check_and_mkdir(os.path.join('python_prod', 'yahoo_api','staging'))
        ...
        with open(os.path.join('python_prod', 'yahoo_api', 'staging',self.run_date, file_name), 'w', newline='') as f:
